...
class PersonaDelMundo (nombre: String, apellidos: String, tipo: String, ingresos: Double) {
...
fun main() {
    val Cliente1 = PersonaDelMundo("Juan", "Perez", "Empresa",120000.00)
    Cliente1.imprimir()
    Cliente1.tipo()
    val Cliente2 = PersonaDelMundo("Luisa", "Lopez", "Sociedad")
    Cliente2.imprimir()
    Cliente2.tipo()
}